        ...
        call.enqueue(new Callback<Void>() {
            ...
            public void onResponse(Call<Void> call, Response<Void> response) {
                if (response.isSuccessful()) {
                    Intent intent = new Intent(UserChangePasswordActivity.this, UserHomeActivity.class);
                    startActivity(intent);
                    Toast.makeText(UserChangePasswordActivity.this, "Password changed successfully", Toast.LENGTH_SHORT).show();
                    // Handle setelah penggantian password sukses
                } else {
                    Toast.makeText(UserChangePasswordActivity.this, "Failed to change password", Toast.LENGTH_SHORT).show();
                    // Handle error
                }
            }
            ...
            public void onFailure(Call<Void> call, Throwable t) {
                Toast.makeText(UserChangePasswordActivity.this, "Error: " + t.getMessage(), Toast.LENGTH_SHORT).show();
                // Handle failure
            }
        });
    }
